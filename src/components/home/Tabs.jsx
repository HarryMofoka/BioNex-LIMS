                    ...
                    <div className="w-full h-full bg-[#0a0a0e]/90 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-6 lg:p-8 relative overflow-hidden flex flex-col shadow-2xl">
                        ...
                        <div className="flex justify-between items-center mb-6 z-10 relative">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-black/40 border border-white/10 rounded-lg cursor-pointer hover:bg-white/5 transition-colors">
                        ...
                        {/* Dash Table Area */}
                        <div className="flex-grow border border-white/10 rounded-xl overflow-hidden bg-black/20 flex flex-col relative z-10">
                            <div className="grid grid-cols-12 gap-4 px-4 py-3 border-b border-white/10 bg-white/[0.02] text-xs text-white/50 font-medium">
